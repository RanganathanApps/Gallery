...
import apps.ranganathan.gallery.sample.Artist;
import apps.ranganathan.gallery.sample.expand.GenreViewHolder;
...
public class MultiCheckGenreAdapter extends
  ...
  public void onBindCheckChildViewHolder(MultiCheckArtistViewHolder holder, int position,
                                         final CheckedExpandableGroup group, final int childIndex) {
